...
var _ = Describe("default-non-prod-ingress-controllers", Serial, func() {
	var (
	...
	Context("when an ingress resource is deployed using 'default-non-prod' ingress controller", func() {
		It("should expose the service to the internet", func() {
			setIdentifier := "integration-test-app-ing-" + namespaceName + "-green"
			class := "default-non-prod"
	...
	Context("when a non-prod-default ingress resource is deployed with an invalid regex path", func() {
