...
EOF
  ...
  is_production          = var.is_production
  team_name              = var.team_name                         # also used for naming the container repository
  namespace              = "cloud-platform-terraform-label-pods" # also used for creating a Kubernetes ConfigMap
...
EOF
  ...
  is_production          = var.is_production
  team_name              = var.team_name                        # also used for naming the container repository
  namespace              = "cloud-platform-github-teams-filter" # also used for creating a Kubernetes ConfigMap
  environment_name       = "production"
  infrastructure_support = var.infrastructure_support
}
