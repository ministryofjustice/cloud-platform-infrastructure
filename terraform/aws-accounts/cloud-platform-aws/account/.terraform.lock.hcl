...
provider "registry.terraform.io/auth0/auth0" {
  version     = "1.21.0"
  constraints = ">= 0.34.0, ~> 1.21.0"
  hashes = [
    "h1:/G2/RClmMf2lQ1IXAKZSv/8r8xllEOsYEEUXwelKWVI=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "5.100.0"
  constraints = ">= 2.23.0, >= 2.50.0, >= 3.0.0, >= 4.0.0, >= 4.2.0, >= 4.8.0, >= 4.40.0, >= 4.45.0, >= 4.63.0, >= 5.70.0, ~> 5.100.0"
  hashes = [
