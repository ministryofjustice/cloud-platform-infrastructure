...
provider "registry.terraform.io/auth0/auth0" {
  version     = "1.31.0"
  constraints = ">= 0.34.0, ~> 1.31.0"
  hashes = [
    "h1:FH0ihopLNT6OEZ38HiMZyX1bKwKQ6R/Q+TbRNnDZCoE=",
    "h1:OW/1Y9pJKR7+oet5FrJlTtcYK3nvVhkCd+7rPaFi0I4=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "6.16.0"
  constraints = ">= 2.23.0, >= 2.50.0, >= 3.0.0, >= 4.0.0, >= 4.2.0, >= 4.8.0, >= 4.40.0, >= 4.45.0, >= 4.63.0, >= 5.70.0, ~> 6.16.0"
  hashes = [
