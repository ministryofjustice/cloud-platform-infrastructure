...
provider "registry.terraform.io/auth0/auth0" {
  version     = "1.32.0"
  constraints = ">= 0.34.0, ~> 1.32.0"
  hashes = [
    "h1:MQ+DJa8IC761mXcPqLI10kI2f5dh7jGqqfCZg8yK3as=",
    "h1:Ty5R1eeOec0txvrfxOQcVu/7LH9A7HEK31ju6yjRN4o=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "6.17.0"
  constraints = ">= 2.23.0, >= 2.50.0, >= 3.0.0, >= 4.0.0, >= 4.2.0, >= 4.8.0, >= 4.40.0, >= 4.45.0, >= 4.63.0, >= 5.70.0, ~> 6.17.0"
  hashes = [
