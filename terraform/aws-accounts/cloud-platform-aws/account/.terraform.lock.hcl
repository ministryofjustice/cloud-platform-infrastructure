...
provider "registry.terraform.io/auth0/auth0" {
  version     = "1.26.0"
  constraints = ">= 0.34.0, ~> 1.26.0"
  hashes = [
    "h1:ZRLHFPnbA2s34L7GHkQxjFL2bGe5IVEuCV2g1IddqAI=",
    "h1:zTjpFzOm1DE58ya0W9I9NYFGJmVxmq2kp81UFBK8Wt4=",
...
provider "registry.terraform.io/hashicorp/aws" {
  version     = "6.8.0"
  constraints = ">= 2.23.0, >= 2.50.0, >= 3.0.0, >= 4.0.0, >= 4.2.0, >= 4.8.0, >= 4.40.0, >= 4.45.0, >= 4.63.0, >= 5.70.0, ~> 6.8.0"
  hashes = [
