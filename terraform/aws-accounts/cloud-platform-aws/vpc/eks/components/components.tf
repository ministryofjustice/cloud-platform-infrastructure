module "concourse" {
  ...
  source = "github.com/ministryofjustice/cloud-platform-terraform-concourse?ref=update"
...
module "cluster_autoscaler" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-cluster-autoscaler?ref=update"
...
module "descheduler" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-descheduler?ref=update"
...
module "cert_manager" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-certmanager?ref=update"
...
module "external_dns" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-external-dns?ref=update"
...
module "ingress_controllers_v1" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-ingress-controller?ref=update"
...
module "kuberos" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-kuberos?ref=update"
...
module "logging" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-logging?ref=update"
...
module "monitoring" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-monitoring?ref=update"
...
module "opa" {
  source     = "github.com/ministryofjustice/cloud-platform-terraform-opa?ref=update"
...
module "velero" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-velero?ref=update"
...
module "kuberhealthy" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-kuberhealthy?ref=update"

  dependence_prometheus = module.monitoring.prometheus_operator_crds_status
}

module "trivy-operator" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-trivy-operator?ref=update"
