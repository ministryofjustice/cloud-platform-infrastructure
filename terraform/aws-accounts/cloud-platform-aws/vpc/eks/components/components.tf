module "concourse" {
  ...
  source = "github.com/ministryofjustice/cloud-platform-terraform-concourse?ref=1.12.0"
...
module "modsec_ingress_controllers_v1" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-ingress-controller?ref=1.2.3"
