module "gatekeeper" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-gatekeeper?ref=fix-gatekeeper-module-version"
  ...
  controller_mem_limit = terraform.workspace == "live" ? "8Gi" : "1Gi"
  controller_mem_req   = terraform.workspace == "live" ? "4Gi" : "512Mi"
