...
module "monitoring" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-monitoring?ref=3.7.4"
  ...
  large_nodesgroup_cpu_requests                    = terraform.workspace == "live" ?  "180000Mi" : "14000Mi"
  large_nodesgroup_memory_requests                 = terraform.workspace == "live" ?  "4000m" :"1300m" 
