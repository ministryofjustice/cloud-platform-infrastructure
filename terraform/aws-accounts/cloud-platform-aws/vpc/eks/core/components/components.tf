...
module "descheduler" {
  ...
  source = "github.com/ministryofjustice/cloud-platform-terraform-descheduler?ref=1.28-upgrade"
...
module "monitoring" {
  source = "github.com/ministryofjustice/cloud-platform-terraform-monitoring?ref=3.9.4"
