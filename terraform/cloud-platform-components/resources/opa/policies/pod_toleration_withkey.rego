...
import data.kubernetes.namespaces
 ...
 deny[msg] {
  ...
  msg := sprintf("Pods %v/%v dont have the key annotation and is not allowed to schedule on master node. Please get in touch with us in #ask-cloud-platform", [input.request.object.metadata.name, input.request.object.spec.tolerations[_]])
 }
